...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.kichutov.grpc_server.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest,
      com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest.class,
      responseType = com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest,
      com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest, com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest, com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest,
                com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse greeting(com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse> greeting(
        com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.kichutov.grpc_server.GreetingServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.kichutov.grpc_server.GreetingServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.kichutov.grpc_server.GreetingServiceOuterClass.getDescriptor();
    }
